// Icono de cubiertos (tenedor y cuchillo). Se usa en los CTA que llevan al
// flujo de pedido (formulario), para diferenciarlos de los de WhatsApp real.
export default function UtensilsIcon({ className = 'w-5 h-5' }) {
  return (
